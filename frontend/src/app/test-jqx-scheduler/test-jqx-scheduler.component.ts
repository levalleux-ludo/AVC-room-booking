...
@Component({
  selector: 'app-test-jqx-scheduler',
  templateUrl: './test-jqx-scheduler.component.html',
  styleUrls: ['./test-jqx-scheduler.component.scss']
})
export class TestJqxSchedulerComponent implements OnInit, AfterViewInit  {
  ...
  generateAppointments(): any {
    ...
    let appointment1 = {
        ...
        calendar: "Room 1",
        start: new Date(2018, 10, 24, 9, 0, 0),
        end: new Date(2018, 10, 24, 16, 0, 0)
    };
    let appointment2 = {
        id: "id2",
        description: "",
    ...
    let appointment3 = {
        ...
        calendar: "Room 3",
        start: new Date(2018, 10, 24, 11, 0, 0),
        end: new Date(2018, 10, 24, 13, 0, 0)
    };
    let appointment4 = {
        id: "id4",
        description: "",
